//
//      xmpp class for windows 10 uwp
//      
//      No Rights Reserved, EXCEPT sell direct or apply for a patent.
//      不允许使用本代码直接出售或申请专利，其他用途没有任何限制。
//      If you want to share your patch, please pull request to <github>.
//      如果你有更新或实现更多内容, 如果愿意共享请发邮件给我。
//
//      Note: support login use tls, compress not implement.
//            *ALL* other actions, such as roster, chat or groupchat, presence manage
//            you need to do it yourself after login successfully.
//
//      Reference: ubiety (search on github)
//
using System;
